...
gsap.from(".info-div", {duration: 1.5, opacity:'0' , scrollTrigger:".info-div-pic1", ease:CustomEase.create("custom", "M0,0,C0.212,0.368,0.514,0.042,0.565,0.775,0.581,1.018,0.78,1,1,1")});
...
gsap.from(".sponsor-image-container-outer", {duration: 2, x:'50%' , scrollTrigger:".member-image", ease: "power4.out"});
